    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white shadow rounded-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="mt-1 text-sm text-gray-500">Update division information.</p>
            </div>
                ...
                <div class="px-6 py-4 space-y-6">
                    ...
                    <div>
                        ...
                        <select name="status" id="status" required
                            ...
                            <option value="active" {{ old('status', $division->status->value) === 'active' ? 'selected' : '' }}>Active</option>
                            <option value="inactive" {{ old('status', $division->status->value) === 'inactive' ? 'selected' : '' }}>Inactive</option>
                        </select>
                        @error('status')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
