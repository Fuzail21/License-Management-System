...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <form method="GET" action="{{ route('admin.departments.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                {{-- Search --}}
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($departments as $department)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {{ $department->division->city->name ?? 'N/A' }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                        {{ $department->employees_count ?? 0 }} {{ Str::plural('employee', $department->employees_count ?? 0) }}
                                    </span>
                                </td>
