            ...
            <div>
                ...
                <div class="mt-1">
                    <select id="status" name="status" required
                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md p-2 border">
                        <option value="active" {{ old('status', $employee->status->value) == 'active' ? 'selected' : '' }}>Active</option>
                        <option value="inactive" {{ old('status', $employee->status->value) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                    </select>
                </div>
                @error('status')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            ...
            <div>
                ...
                <div class="mt-1">
                    <select id="head" name="head" required
                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md p-2 border">
                        <option value="1" {{ old('head', $employee->head) == '1' ? 'selected' : '' }}>Yes</option>
                        <option value="0" {{ old('head', $employee->head) == '0' ? 'selected' : '' }}>No</option>
                    </select>
                </div>
                @error('head')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
